$(function () {
    ...
    switch (query.key) {
        case "t":
            targets = ["tags"];
            $('.search-title').text('タグ: ' + query.query)
            break;
        case "a":
            targets = ["author"];
            $('.search-title').text('著者: ' + query.query)
            break;
        case "d":
            targets = ["date"];
            $('.search-title').text('日付: ' + query.query)
            break;
        case "q":
        default:
    ...
    if (query.key == "q") {
        $('.search-title').text('検索結果: ' + query.query)
